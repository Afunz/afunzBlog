              ...
              label-width="80px">
                <el-row>
                  <el-col :span="4">
                    ...
                    <el-input v-model="searchFormData.titleFuzzy" placeholder="请输入标题" clearable @keyup.enter.native="loadDataList">
                    </el-input>
                  </el-form-item>
                  </el-col>
                  <el-col :span="4">
                  ...
                  <el-col :span="5" :style="{'padding-left' : '10px'}">
                    ...
                    <el-button type="primary" @click="showEdit('add')">新增博客</el-button>
                  </el-col>
                </el-row>  
          </el-form>
  </div>
